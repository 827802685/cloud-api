...
- `packages/core/migrations-d1/0017_gemini_models_generate.sql`
- `packages/core/migrations-postgres/0017_gemini_models_generate.sql`
- `packages/core/migrations-mysql/0017_gemini_models_generate.sql`
...
1. 备份数据库。
2. 应用 `0017_gemini_models_generate`（见 §2）。
3. 复核冲突 Pool（见 §3）。
