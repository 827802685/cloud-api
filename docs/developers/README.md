...
| 查计费、审计、时间、Provider 参数、文生图 / 语音转写等行为语义 | [reference/](./reference/)（含 [image-models.md](./reference/image-models.md)）；Audio 见 [api/user.md「语音转写」](./api/user.md#语音转写audio-transcriptions) |
