...
function endpointIdentity(url: URL): ProviderCatalogIdentity | null {
	...
	const domainRules: ReadonlyArray<readonly [string, ProviderCatalogIdentity]> = [
		...
		['github.ai', identity('github')],
		['huggingface.co', identity('huggingface')],
		['api.cloudflare.com', identity('cloudflare')],
		['kilo.ai', identity('kilo')],
		['ovhcloud.net', identity('ovh')],
		['kepler.ai.cloud.ovh.net', identity('ovh')],
		['aihorde.net', identity('aihorde')],
		['modelscope.cn', identity('modelscope')],
		['pollinations.ai', identity('pollinations')],
		['routeway.ai', identity('routeway')],
		['routeway.xyz', identity('routeway')],
		['llm7.io', identity('llm7')],
		['reka.ai', identity('reka')],
		['ainative.studio', identity('ainative')],
		['requesty.ai', identity('requesty')],
		['navyai.com', identity('navyai')],
		['navy.ai', identity('navyai')],
		['nararouter.com', identity('nararouter')],
		['bynara.id', identity('nararouter')],
		['sea-lion.ai', identity('sealion')],
		['agnes.ai', identity('agnes')],
		['agnes-ai.com', identity('agnes')],
		['bazaarlink.ai', identity('bazaarlink')],
		['ollama.com', identity('ollama')],
		['aionlabs.ai', identity('aion')],
	];
...
function identityFromNameHint(normalizedName: string): ProviderCatalogIdentity | null {
	...
	const vendorRules: ReadonlyArray<readonly [readonly string[], ProviderCatalogIdentity]> = [
		...
		[['github models', 'github'], identity('github')],
		[['huggingface', 'hugging face', 'hf'], identity('huggingface')],
		[['cloudflare', 'workers ai'], identity('cloudflare')],
		[['kilo'], identity('kilo')],
		[['ovh'], identity('ovh')],
		[['ai horde', 'aihorde', 'horde'], identity('aihorde')],
		[['modelscope', '魔搭'], identity('modelscope')],
		[['pollinations'], identity('pollinations')],
		[['routeway'], identity('routeway')],
		[['llm7'], identity('llm7')],
		[['reka'], identity('reka')],
		[['ainative'], identity('ainative')],
		[['requesty'], identity('requesty')],
		[['navyai', 'navy ai'], identity('navyai')],
		[['nararouter', 'nara router'], identity('nararouter')],
		[['sea-lion', 'sealion'], identity('sealion')],
		[['agnes'], identity('agnes')],
		[['bazaarlink', 'bazaar'], identity('bazaarlink')],
		[['aion'], identity('aion')],
	];
